...
import { Mail, Lock, Eye, ArrowRight, TrendingUp, Info } from "lucide-react";
        ...
        <form className="flex flex-col gap-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 px-3 py-2.5 bg-card border border-border rounded-lg focus-within:border-gold/40">
              ...
              />
              <Eye className="w-3.5 h-3.5 text-text-subtle cursor-pointer" />
            </div>
          </div>

          <label className="flex items-center gap-2 mt-1 cursor-pointer">
            <input type="checkbox" className="accent-[#F5C66B] w-3 h-3" defaultChecked />
            <span className="text-[11px] text-text-muted">Remember me for 30 days</span>
          </label>

          <Link
            href="/dashboard"
            className="mt-2 py-2.5 bg-gold text-gold-dark rounded-lg text-[13px] font-medium flex items-center justify-center gap-2 hover:brightness-110 transition"
          >
          ...
          <button
            type="button"
            className="py-2.5 bg-transparent border border-border-strong text-text rounded-lg text-[12px] hover:bg-card transition"
          >
            Create an account
          </button>
        </form>
